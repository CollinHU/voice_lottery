...
[点击跳转至中文使用文档](https://github.com/CollinHU/voice_lottery/blob/master/README-ZH_CN.MD)
...
## Get AI Token and Prepare company logo
Referto /server/.env.example 
```
#Token
cd /lottery/server
mv .env.example .env
#apply for token from AliCloud service

#Replace company logo
cd ../product/src/img
#put the logo.png here
```
